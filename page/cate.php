<div class="box">
   ...
   <h3 class="title"><?php echo $detailCateArr['name']; ?> <a href="<?php echo $detailCateArr['slug']; ?>" title="View more <?php echo $detailCateArr['name']; ?>"><i class="glyphicon glyphicon-chevron-right"></i></a></h3>
   <div class="movie-list">
      <?php foreach ($videoArr['data'] as $key => $value) { ?>
